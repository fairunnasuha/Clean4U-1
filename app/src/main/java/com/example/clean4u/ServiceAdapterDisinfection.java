...
public class ServiceAdapterDisinfection extends RecyclerView.Adapter<ServiceAdapterDisinfection.ServiceViewHolder> {
    ...
    public ServiceAdapterDisinfection(Context context, List<Service> serviceList) {
