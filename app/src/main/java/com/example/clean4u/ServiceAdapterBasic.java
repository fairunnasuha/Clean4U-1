...
public class ServiceAdapterBasic extends RecyclerView.Adapter<ServiceAdapterBasic.ServiceViewHolder> {
    ...
    public ServiceAdapterBasic(Context context, List<Service> serviceList) {
