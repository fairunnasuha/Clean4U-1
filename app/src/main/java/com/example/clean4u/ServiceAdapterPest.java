...
public class ServiceAdapterPest extends RecyclerView.Adapter<ServiceAdapterPest.ServiceViewHolder> {
    ...
    public ServiceAdapterPest(Context context, List<Service> serviceList) {
